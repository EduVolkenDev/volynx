...
export const DEVJOURNEY_DELIVERABLES = [
  {
    ...
    summaryEn: "Blocks 0-2 with updated Start Here guides, setup checklist, glossaries, starter projects and brand assets.",
    summaryPt: "Blocos 0-2 com Comece Aqui atualizado, checklist de setup, glossários, projetos starter e brand assets.",
  ...
  },
  {
    ...
    summaryEn: "Everything in Social plus Block 3, React/Vite starter and updated review/certification guidance.",
    summaryPt: "Tudo do Social, mais Bloco 3, starter React/Vite e orientação atualizada de revisão/certificação.",
  ...
  },
  {
    ...
    summaryEn: "The full track: React, API, deploy workflow, updated certification guidance and the Arsenal Kit.",
    summaryPt: "A trilha completa: React, API, workflow de deploy, orientação atualizada de certificação e Arsenal Kit.",
