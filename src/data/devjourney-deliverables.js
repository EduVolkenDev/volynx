...
export const DEVJOURNEY_DELIVERABLES = [
  {
    ...
    summaryEn: "Blocks 0-2 with updated Start Here guides, setup checklist, glossaries, starter projects, approved Dev Journey assets and an optional icon pack.",
    summaryPt: "Blocos 0-2 com Comece Aqui atualizado, checklist de setup, glossários, projetos starter, assets aprovados do Dev Journey e pack opcional de ícones.",
  ...
  },
  {
    ...
    summaryEn: "Everything in Social plus Block 3, React/Vite starter, approved Dev Journey assets, optional icons and updated review/certification guidance.",
    summaryPt: "Tudo do Social, mais Bloco 3, starter React/Vite, assets aprovados do Dev Journey, ícones opcionais e orientação atualizada de revisão/certificação.",
  ...
  },
  {
    ...
    summaryEn: "The full track: React, API, deploy workflow, approved Dev Journey assets, optional icons, updated certification guidance and the Arsenal Kit.",
    summaryPt: "A trilha completa: React, API, workflow de deploy, assets aprovados do Dev Journey, ícones opcionais, orientação atualizada de certificação e Arsenal Kit.",
