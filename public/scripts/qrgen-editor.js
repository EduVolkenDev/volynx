...
(function () {
  ...
  const I18N = {
    pt: {
      ...
      "hero.title": "Crie um código QR alinhado à sua marca.",
      "hero.subtitle": "Crie códigos QR limpos, personalizados e prontos para exportação, com prévia em tempo real, controles inteligentes e suporte a campanhas dinâmicas.",
      "plan.status": "Plano atual do QRGen",
      "plan.free_copy": "Prévia em tempo real e exportação PNG padrão.",
      "plan.cta": "Desbloquear Pro",
      "editor.kicker": "Editor",
      "editor.title": "Conteúdo e controles de marca",
      "content.legend": "Projeto",
      "content.name": "Nome do código QR",
      "content.static": "Código QR estático",
      "content.dynamic": "Código QR dinâmico",
      "content.value": "Link, texto ou destino da campanha",
      "content.example": "Prévia de exemplo: insira seu conteúdo para personalizar.",
      ...
      "style.metallic_volynx": "Verde-azulado VOLYNX",
      "style.error": "Correção de erro",
      "style.dot_color": "Cor do código QR",
      "style.dot_color_2": "Final do gradiente",
      "style.bg": "Fundo",
      "style.preview_size": "Tamanho da prévia",
      ...
      "export.button": "Exportar código QR final",
      "project.save": "Salvar projeto",
      "projects.kicker": "Projetos",
      "projects.title": "Área de códigos QR salvos",
      "projects.copy": "Os rascunhos ficam salvos neste navegador. Códigos QR dinâmicos permanecem disponíveis no gerenciador.",
      "dynamic.title": "Códigos QR dinâmicos e campanhas",
      "dynamic.copy": "A VOLYNX oferece redirecionamentos dinâmicos. Métricas e campanhas permanecem vinculadas apenas a códigos QR dinâmicos reais.",
      "dynamic.create_title": "Criar código QR dinâmico gerenciado",
      "dynamic.login_required": "Entre na sua conta para criar códigos QR dinâmicos que poderão ser editados posteriormente.",
      ...
      "dynamic.err_login": "Entre na sua conta para criar códigos QR dinâmicos e editáveis.",
      "dynamic.err_quota": "Você atingiu o limite do plano. Faça upgrade ou pause um código QR.",
      "dynamic.err_generic": "Não foi possível criar o código QR dinâmico. Tente novamente.",
      "dynamic.err_collision": "O endereço gerado já está em uso. Tente novamente.",
      "dynamic.item1": "Destino editável depois da impressão",
      "dynamic.item2": "Métricas baseadas em dados reais",
      "dynamic.item3": "Organização por campanha e cliente",
      "dynamic.manage": "Abrir gerenciador de códigos QR dinâmicos",
      "plans.kicker": "Planos QRGen",
      "plans.title": "Muito mais do que um gerador gratuito de códigos QR.",
      "account.product": "Área QRGen",
      "account.guest": "Sem login ativo",
      "account.login": "Entrar",
      "account.signup": "Criar conta",
      "account.profile": "Perfil",
      "account.codes": "Meus códigos QR",
      "account.admin": "Admin",
      "account.admin_codes": "Administração de códigos QR",
      "dynamic.admin_manage": "Abrir administração de códigos QR",
      "account.logout": "Sair",
      "projects.empty": "Nenhum projeto de código QR foi salvo. Salve este design para criar seu primeiro rascunho local.",
      "projects.dynamic_preview": "Prévia dinâmica",
      "projects.open": "Abrir",
      ...
      "plans.free.copy": "Para rascunhos rápidos de códigos QR estáticos e arquivos PNG padrão.",
      ...
      "plans.studio.f1": "Suporte a códigos QR dinâmicos",
      "plans.studio.f2": "Organização por campanha",
      "plans.studio.f3": "Estrutura de métricas preparada",
